        ...
        <div className="mt-10 sm:mt-14 grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div data-hero-headline>
              ...
              <p data-hero-tagline className="mt-5 font-serif text-2xl sm:text-3xl text-[#f4f5f7] italic font-normal tracking-tight">
            ...
            <div data-hero-ctas>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-2.5 bg-[#a8e08f] px-8 py-4 text-xs font-bold uppercase tracking-wider text-[#120d1c] transition-all hover:bg-[#b9ea9f] shadow-xl shadow-[#a8e08f]/20 active:scale-[0.98]"
                >
            ...
            {stats.map((s) => (
              <div key={s.label} className="bg-[#120d1c] px-4 sm:px-6 py-4 sm:py-5">
                <CountUp
                  value={s.value}
                  suffix={s.suffix}
                  className="block font-mono text-2xl sm:text-3xl font-extrabold text-[#b497cf]"
                />

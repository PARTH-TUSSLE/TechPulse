...
export default function PulseWatermark() {
  ...
  return (
    <div
      ref={ref}
      className="pointer-events-none absolute inset-0 flex items-center justify-center select-none aspect-square w-[min(92vw,30rem)] max-h-[85vh] lg:w-[min(70vw,40rem)] m-auto overflow-hidden"
      aria-hidden="true"
    />
  );
}